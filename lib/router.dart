  ...
  routes: [
    ShellRoute(
      ...
      routes: [
        ...
        GoRoute(path: '/profile', builder: (context, state) => const SizedBox.shrink()),
    ...
    GoRoute(
      ...
      builder: (context, state) {
        ...
        // If post is null, we could retrieve it from SharedPreferences here
        // based on the ID, but for now we'll just use what's passed
